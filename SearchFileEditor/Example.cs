    ...
    public partial class SearchFileEditorConfig
    {
        ...
        public static SearchFileEditorConfig ExampleFile
        {
            get
            {
                ...
                pConfig.arrEditFile[0] = new EditFileInfo(EditFileInfo.EFileType.json, $"/Example/{JsonExample.const_FileName}", "User.Nickname", "Strix");
                pConfig.arrEditFile[1] = new EditFileInfo(EditFileInfo.EFileType.json, $"/Example/{JsonExample.const_FileName}", "GithubURL", "https://github.com/KorStrix");
                pConfig.arrEditFile[2] = new EditFileInfo(EditFileInfo.EFileType.yaml, $"/Example/{YamlExample.const_FileName}", "Example.thisProgramName", "SFE");
